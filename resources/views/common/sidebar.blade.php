...
@endhasrole -->
    ...
    @hasrole('Admin')
        <li class="nav-item {{ request()->is('commoditie*') ? 'active' : '' }}">
    ...
    @hasrole('Admin')
        <li class="nav-item {{ request()->is('exit*') ? 'active' : '' }}">
    ...
    @hasrole('Admin')
        <li class="nav-item {{ request()->is('via*') ? 'active' : '' }}">
    ...
    @hasrole('salesman')
        ...
        <li class="nav-item {{ request()->is('dispatch/searchview') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('dispatch.searchview') }}">
                <i class="fas fa-fw fa-search"></i>
    ...
    @hasrole('Admin')
        ...
        <li class="nav-item ">
            ...
            <ul class="navbar-nav sidebar-dark">
                ...
                <li class="nav-item {{ request()->is('users/import-users') ? 'active' : '' }}">
