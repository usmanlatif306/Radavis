...
@section('title', 'Add Location Tier')

@section('content')
    @include('common.breadcrumbs', [
        'title' => 'Add Location Tier',
        'btn_text' => 'Back',
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header d-flex align-items-center card-header-height">
                    <h6 class="font-weight-bold text-primary mb-0 pb-0">Add New Location Tier</h6>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 mb-6">
                                ...
                                <input type="text"
                                    ...
                                    id="ending" placeholder="Ending Mileage" name="ending" value="{{ old('ending') }}">
