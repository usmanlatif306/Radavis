...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Bulletin</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Bulletin</h6>
            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 mb-3 mt-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user @error('status') is-invalid @enderror"
                                ...
                                <option value="1" @selected(old('status', $bulletin->status) == 1 ? 'selected' : '')>Active</option>
                                <option value="0" @selected(old('status', $bulletin->status) == 0 ? 'selected' : '')>Inactive</option>
                            </select>
                            @error('status')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
