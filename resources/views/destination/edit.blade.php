                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 mb-6 mt-6 mb-sm-0">
                        ...
                        <input 
                            ...
                            placeholder="Name" 
                            name="name" 
                            value="{{ old('name') ?  old('name') : $destination->name}}">
                    ...
                    <div class="col-sm-12 mb-6 mt-6 mb-sm-0">
                        ...
                        <select class="form-control form-control-destination @error('status') is-invalid @enderror" name="active">
                            <option selected disabled>Select Status</option>
                            <option value="1" {{($destination->active == 1) ? 'selected' : ''}}>Active</option>
                            <option value="0" {{($destination->active == 0) ? 'selected' : ''}}>Inactive</option>
                        </select>
                        @error('status')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
