        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header card-header-height d-flex align-items-center">
                    <h6 class="font-weight-bold text-primary mb-0 pb-0">Edit Truck</h6>
                </div>
                ...
                <form method="POST" action="{{ route('via.update', ['via' => $via->id]) }}">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox"
                                        value="Walking Floor" id="WalkingFloor" @checked(in_array('Walking Floor', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Belt"
                                        id="Belt" @checked(in_array('Belt', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Hopper"
                                        id="Hopper" @checked(in_array('Hopper', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Doubles"
                                        id="Doubles" @checked(in_array('Doubles', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Low-side"
                                        id="Low-side" @checked(in_array('Low-side', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Dump"
                                        id="Dump" @checked(in_array('Dump', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Curtain"
                                        id="Curtain" @checked(in_array('Curtain', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Reefer"
                                        id="Reefer" @checked(in_array('Reefer', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Dry Van"
                                        id="Dry-Van" @checked(in_array('Dry Van', old('equip_type', $via->equip_type)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="equip_type[]" type="checkbox" value="Flatbed"
                                        id="Flatbed" @checked(in_array('Flatbed', old('equip_type', $via->equip_type)))>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="HTV"
                                        id="HTV" @checked(in_array('HTV', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="MOT"
                                        id="MOT" @checked(in_array('MOT', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="KERN"
                                        id="KERN" @checked(in_array('KERN', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="NORCAL"
                                        id="NORCAL" @checked(in_array('NORCAL', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="SOCAL"
                                        id="SOCAL" @checked(in_array('SOCAL', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="OTR"
                                        id="OTR" @checked(in_array('OTR', old('service_area', $via->service_area)))>
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" name="service_area[]" type="checkbox" value="FOB"
                                        id="FOB" @checked(in_array('FOB', old('service_area', $via->service_area)))>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success btn-via float-right mb-6">Update</button>
