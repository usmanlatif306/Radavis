...
<div class="container-fluid">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ str_replace('.00', '', number_format($data['load_shipped'], 2)) }}
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mt-4">
            ...
            <div class="table-responsive">
                <table id="scoreboard" class="table table-hover table-bordered responsive" width="100%" cellspacing="0">
                    <thead>
                        <tr>
        ...
        <div class="col-md-12 mt-4">
            ...
            <div class="table-responsive">
                <table id="products" class="table table-hover table-bordered responsive" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="text-center" style="width: 5%;"></th>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="d-flex align-items-center justify-content-between" style="background-color: rgb(0, 67, 135); color: white; padding: 10px; font-weight: bold;">
        ...
        <div class="col-md-12 mt-4">
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-hover table-bordered responsive" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $dispatch->release_code == '' ? 'table-info' : ' ' }}{{ $dispatch->noship == 1 ? 'table-danger' : ' ' }}{{ $dispatch->void == 1 ? 'table-dark' : ' ' }}{{ $dispatch->delivered == 1 ? 'table-success' : ' ' }}" @if ($dispatch->void == 1) style="background-color: #D3D3D3; text-decoration: line-through;" @endif>
