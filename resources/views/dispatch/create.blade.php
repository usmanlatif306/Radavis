...
<div class="modal fade" id="createModal" role="dialog" aria-labelledby="deleteModalExample"
    aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <form method="POST" id= "disptach-form" action="{{route('dispatch.store')}}">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "add-commoditie" onchange = "UpdateSuppliers()" class="form-control form-control-user @error('commodity') is-invalid @enderror" name="commodity_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "add-supplier" onchange = "Updateexits()" class="form-control form-control-user @error('supplier') is-invalid @enderror" name="supplier_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "add-exits" class="form-control form-control-user @error('exit') is-invalid @enderror" name="exit_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('via') is-invalid @enderror" name="via_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('Rate') is-invalid @enderror" name="rate_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('salesman') is-invalid @enderror" name="salesman">
                                    <option selected disabled>Select Salesman</option>
                                    <option value=""></option>
                                    @foreach ($users->sortBy('first_name') as $user)
                                        <option value="{{$user->id}}" <?php if( $select_sale_man != ''){  if($user->id == Auth::user()->id) {  echo 'selected'; }  } ?>  >{{$user->first_name}}</option>
                                    @endforeach
                                </select>
                                @error('salesman')
                                    <span class="text-danger">{{$message}}</span>
                    ...
                    <div class="modal-footer">
                        <button type="button" id= "add-disptach" class="btn btn-success btn-user float-right mb-3">Save</button>
