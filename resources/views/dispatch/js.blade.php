    ...
    $(document).ready(function() {
        ...
        $('#myTable').on('click', 'td.details-control', function () {
            ...
            if (row.child.isShown()) {
                ...
                strAdditional = strAdditional + '<td style="width:33%"><span class="dtr-title">Driver</span></td>';
                strAdditional = strAdditional + '<td style="width:33%"><span class="dtr-title">Sales</span></td>';
                strAdditional = strAdditional + '<td style="width:33%"><span class="dtr-title">Accounts</span></td></tr>';
                strAdditional = strAdditional + '<tr><td>';
                if($(this).closest('tr').find('.driver_instructions').length)
                {
                    strAdditional = strAdditional+format($(this).closest('tr').find('.driver_instructions').val())
                }
                strAdditional = strAdditional + '</td><td style="width:33%">';
                if($(this).closest('tr').find('.sales_notes').length)
                {
                    strAdditional = strAdditional+format($(this).closest('tr').find('.sales_notes').val())
                }
                strAdditional = strAdditional + '</td><td style="width:33%">';
                if($(this).closest('tr').find('.accounting_notes').length)
                {
                    strAdditional = strAdditional+format($(this).closest('tr').find('.accounting_notes').val())
                }
