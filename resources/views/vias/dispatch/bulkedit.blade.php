<div class="modal fade" id="bulkeditModal" role="dialog" aria-labelledby="deleteModalExample"
    aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select  onchange = "BulkUpdateSuppliers()" class="form-control form-control-user @error('commodity') is-invalid @enderror" name="commodity_id" id="add-commoditie">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id="add-supplier"  onchange = "BulkUpdateexits()" class="form-control form-control-user @error('supplier') is-invalid @enderror" name="supplier_id" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select  class="form-control form-control-user @error('exit') is-invalid @enderror" name="exit_id" id="add-exits" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('via') is-invalid @enderror" name="via_id" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('destination') is-invalid @enderror" name="destination_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('Rate') is-invalid @enderror" name="rate_id" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select class="form-control form-control-user @error('salesman') is-invalid @enderror" name="salesman" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Completed</label>
                                <select class="form-control form-control-user @error('status') is-invalid @enderror" name="delivered">
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Ship</label>
                                <select  class="form-control form-control-user @error('status') is-invalid @enderror" name="noship">
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Void</label>
                                <select class="form-control form-control-user @error('status') is-invalid @enderror" name="void">
