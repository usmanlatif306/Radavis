<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalExample"
    aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <form id="frmEdit" method="POST" action="{{route('dispatch.update')}}">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" class="form-control form-control-user"  id="dispatch" name="dispatch_id"  value="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "edit-commoditie" onchange = "EditUpdateSuppliers()" class="form-control form-control-user @error('commodity') is-invalid @enderror" name="commodity_id">
                                    <option selected disabled>Select Commodity</option>
                                    @foreach ($commodities->sortBy('name') as $commoditie)
                                        <option style="color:{{$commoditie->color}}" value="{{$commoditie->id}}">{{$commoditie->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "edit-supplier" onchange = "EditUpdateexits()" class="form-control form-control-user @error('supplier') is-invalid @enderror" name="supplier_id" @if(Auth::user()->hasRole('salesman')) disabled="disabled" @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id = "edit-exits" class="form-control form-control-user @error('exit') is-invalid @enderror" name="exit_id" @if(Auth::user()->hasRole('salesman')) disabled="disabled" @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id="edit-via" class="form-control form-control-user @error('via') is-invalid @enderror" name="via_id" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id="edit-destination" class="form-control form-control-user @error('destination') is-invalid @enderror" name="destination_id">
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id="edit-rate" class="form-control form-control-user @error('Rate') is-invalid @enderror" name="rate_id" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                                ...
                                <select id="edit-salesman" class="form-control form-control-user @error('salesman') is-invalid @enderror" name="salesman" @if (Auth::user()->hasRole('salesman')) 
                                        disabled="disabled" 
                                    @endif>
                            ...
                            <div class="col-sm-12 mb-6 mt-6 mb-sm-0">
                                ...
                                <textarea 
                                    class="form-control form-control-user @error('sales_notes') is-invalid @enderror" 
                                    id="edit_sales_notes"
                                    placeholder="Sales Notes" 
                                    name="sales_notes" 
                                    value="{{ old('sales_notes') }}"></textarea>
                                @error('sales_notes')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12 mb-6 mt-6 mb-sm-0">
                                ...
                                <textarea 
                                    class="form-control form-control-user @error('accounting_notes') is-invalid @enderror" 
                                    id="edit_accounting_notes"
                            ...
                            <div class="col-sm-12 mb-6 mt-6 mb-sm-0">
                                ...
                                <textarea 
                                    class="form-control form-control-user @error('driver_instructions') is-invalid @enderror" 
                                    id="edit_driver_instructions"
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Completed</label>
                                <select id="edit_delivered" class="form-control form-control-user @error('status') is-invalid @enderror" name="delivered">
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Don't ship</label>
                                <select id="edit_noship" class="form-control form-control-user @error('status') is-invalid @enderror" name="noship">
                            ...
                            <div class="col-sm-4 mb-2 mt-2 mb-sm-0">
                                Void</label>
                                <select id="edit_void" class="form-control form-control-user @error('status') is-invalid @enderror" name="void">
                    ...
                    <div class="modal-footer">
                        ...
                        <a data-ide = "" id="change-log-button" class="btn btn-primary float-right mr-3 mb-3" href="javascript:void(0)" onclick="changelog({{ $dispatch->id ?? '0'}})">Change Log</a>
                    </div>
                </form>
        </div>
    </div>
...
<div class="modal fade" id="confirmeditmmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Sorry, this release code has already been used. Do you wish to save this record anyway?</div>
            <div class="modal-footer">
