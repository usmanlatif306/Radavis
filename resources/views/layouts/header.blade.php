    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('home') }}" class="d-lg-none">
                <img alt="Logo" src="http://radavisdispatch.com/rad-logo-2.png" class="theme-light-show h-30px" />
                <img alt="Logo" src="http://radavisdispatch.com/rad-logo-2.png" class="theme-dark-show h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                ...
                <div class="app-navbar-item ms-2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('profile.detail') }}" class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
